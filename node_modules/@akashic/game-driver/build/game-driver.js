...
var Clock = /** @class */ (function () {
    function Clock(param) {
        ...
        if (param.frameHandler) {
            this.frameTrigger.handle(param.frameHandlerOwner, param.frameHandler);
        }
        this.running = false;
...
},{"@akashic/akashic-engine":22}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./PointEventResolver":13,"@akashic/akashic-engine":22,"@akashic/akashic-pdi":23}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@akashic/akashic-engine":22}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@akashic/akashic-engine":22}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var GameDriver = /** @class */ (function () {
    ...
    GameDriver.prototype._putZerothStartPoint = function (data) {
        ...
        return new es6_promise_1.Promise(function (resolve, reject) {
            ...
            var zerothStartPoint = { frame: 0, timestamp: 0, data: data };
...
},{"./EventBuffer":2,"./ExecutionMode":5,"./Game":6,"./GameLoop":8,"./PdiUtil":12,"@akashic/akashic-engine":22,"es6-promise":24}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var GameLoop = /** @class */ (function () {
    ...
    GameLoop.prototype._doLocalTick = function () {
        ...
        var sceneChanged = game.tick(false);
        if (sceneChanged)
            this._handleSceneChange();
    };
    /**
    ...
    GameLoop.prototype._onFrameForTimedReplay = function (frameArg) {
        ...
        for (var i = 0; i < this._skipTicksAtOnce; ++i) {
    ...
    GameLoop.prototype._onFrameNormal = function (frameArg) {
        ...
        for (var i = 0; i < loopCount; ++i) {
            ...
            if (tick != null) {
                var plEvents = this._eventBuffer.readLocalEvents();
                if (plEvents) {
                    for (var k = 0, len = plEvents.length; k < len; ++k) {
    ...
    GameLoop.DEFAULT_DELAY_IGNORE_THRESHOLD = 6; // このフレーム以下の遅延は遅れてないものとみなす(常時コマが飛ぶのを避けるため)
    GameLoop.DEFAULT_SKIP_TICKS_AT_ONCE = 100; // 100倍早送り
    GameLoop.DEFAULT_SKIP_THRESHOLD = 30000; // 30FPSの100倍早送りで換算3000FPSで進めて10秒かかる閾値
    GameLoop.DEFAULT_JUMP_TRY_THRESHOLD = 90000; // 30FPSの100倍早送りで換算3000FPSで進めても30秒かかる閾値
    GameLoop.DEFAULT_JUMP_IGNORE_THRESHOLD = 15000; // 30FPSの100倍早送りで換算3000FPSで進めて5秒で済む閾値
    GameLoop.DEFAULT_POLLING_TICK_THRESHOLD = 10000; // 最新ティックを取得する間隔
    GameLoop.DEFAULT_DELAY_IGNORE_THERSHOLD = GameLoop.DEFAULT_DELAY_IGNORE_THRESHOLD; // 過去のtypoの後方互換性維持
    return GameLoop;
}());
exports.GameLoop = GameLoop;

},{"./Clock":1,"./EventConverter":3,"./ExecutionMode":5,"./LoopMode":10,"./LoopRenderMode":11,"./ProfilerClock":14,"./TickController":17,"@akashic/akashic-engine":22}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@akashic/akashic-engine":22}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * `GameLoop` のループ制御のモード。
...
},{"@akashic/akashic-engine":22,"es6-promise":24}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Clock":1}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ExecutionMode":5,"@akashic/akashic-engine":22}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
        ...
        if (age === range.start) {
            ...
            for (var i = 0; i < pevs.length; ++i) {
                if (pevs[i][0 /* Code */] === 2 /* Timestamp */) {
                    this._nextTickTimeCache = pevs[i][3 /* Timestamp */];
                    return this._nextTickTimeCache;
                }
            }
            return null;
...
},{"./ExecutionMode":5,"@akashic/akashic-engine":22}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ExecutionMode":5,"./StorageResolver":15,"./TickBuffer":16,"./TickGenerator":18,"@akashic/akashic-engine":22}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./JoinResolver":9,"@akashic/akashic-engine":22}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var SimpleProfiler = /** @class */ (function () {
    function SimpleProfiler(param) {
        ...
        if (param.getValueHandler) {
            this._calculateProfilerValueTrigger.handle(param.getValueHandlerOwner, param.getValueHandler);
        }
        this._reset();
    }
...
},{"@akashic/akashic-engine":22}],22:[function(require,module,exports){
module.exports = require('./lib/main.node');
},{"./lib/main.node":"/node_modules/@akashic/akashic-engine/lib/main.node.js"}],23:[function(require,module,exports){
"use strict";
...
},{"./EventIndex":4,"./ExecutionMode":5,"./Game":6,"./GameDriver":7,"./LoopMode":10,"./LoopRenderMode":11,"./auxiliary/MemoryAmflowClient":19,"./auxiliary/ReplayAmflowProxy":20,"./auxiliary/SimpleProfiler":21}]},{},[]);
