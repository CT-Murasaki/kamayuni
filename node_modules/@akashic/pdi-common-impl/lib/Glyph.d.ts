 ...
 */
export declare class Glyph implements pdi.Glyph {
    /**
     * 文字コード。
     */
    code: number;
     ...
     * @deprecated 非推奨である。将来的に削除される予定である。
     */
    constructor(code: number, x: number, y: number, width: number, height: number, offsetX?: number, offsetY?: number, advanceWidth?: number, surface?: pdi.Surface, isSurfaceValid?: boolean);
    /**
     * グリフの描画上の幅を求める。
