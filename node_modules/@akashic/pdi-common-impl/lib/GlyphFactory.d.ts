 ...
 */
export declare abstract class GlyphFactory implements pdi.GlyphFactory {
    /**
     * フォントファミリ。
     *
     ...
     */
    constructor(fontFamily: string | string[], fontSize: number, baselineHeight?: number, fontColor?: string, strokeWidth?: number, strokeColor?: string, strokeOnly?: boolean, fontWeight?: pdi.FontWeightString);
    /**
     * グリフの生成。
     *
